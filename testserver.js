...
// show all the products then 2 questions: ID of the product they want to buy and the number of units
function startPurchase() {
    ...
    connection.query('SELECT * FROM products', function (err, res) {
        ...
        //show ID, product_name, department_name, and price -- do this with a for loop
